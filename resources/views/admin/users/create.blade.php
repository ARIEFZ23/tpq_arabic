        ...
        <form action="{{ route('admin.users.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <select name="role" id="role" required
                    ...
                    <option value="ustadzah" {{ old('role') == 'ustadzah' ? 'selected' : '' }}>Ustadzah</option>
                    <option value="santri_putra" {{ old('role') == 'santri_putra' ? 'selected' : '' }}>Santri Putra</option>
                    <option value="santri_putri" {{ old('role') == 'santri_putri' ? 'selected' : '' }}>Santri Putri</option>
                </select>
                @error('role')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
