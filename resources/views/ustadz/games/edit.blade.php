    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-xl shadow-lg p-8">
                <div class="mb-6">
                    <h3 class="text-2xl font-bold text-gray-800 mb-2">Edit Informasi Game</h3>
                    <p class="text-gray-600">Update informasi game pembelajaran</p>
                </div>

                <form action="{{ route('ustadz.games.update', $game->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-6">
                        ...
                        >
                            ...
                            @foreach($gameTypes as $key => $label)
                                <option value="{{ $key }}" {{ old('type', $game->type) == $key ? 'selected' : '' }}>
                                    {{ $label }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-6 bg-yellow-50 border-l-4 border-yellow-500 p-4 rounded-lg">
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-yellow-700">Mengubah tipe game mungkin mempengaruhi pertanyaan yang sudah ada. Pastikan untuk memeriksa kembali pertanyaan setelah mengubah tipe game.</p>
                            </div>
                        </div>
                    </div>
